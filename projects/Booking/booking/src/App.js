...
function App() {
  const [freshVal, setfreshVal] = useState(null);
  return (
    <BrowserRouter>
      <>
        <div className="main">
          <div className="main-header">
            <div className="header">
              ...
              <div className="text">
                ...
                <h4 className="List">List your Property</h4>
            ...
            <div className='sidualBar'>
              <div className='serchBar'>
                <input type="text" placeholder='Where are you going?' value={freshVal} onChange={(e) => setfreshVal(e.target.value)} />
              </div>
              <div className='serchBar'>
